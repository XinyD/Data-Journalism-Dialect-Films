...
- **首页宇宙**：发布记录 63,025 部，覆盖封面与引言、十幕叙事（对照 / 拐点 / 全球参照 / 失败路径 / 同导演 / 三波浪潮 / 五维 / 刻度坐标系 / 下限 / 立尺）及终章回响。序章可视点约 10,800 颗陆地粒子，封面另加约 7,500 颗尘埃，不是 6 万颗同时画满。
...
- **第十幕立尺**：粒子按六级产区聚成横带，刻度字浮在粒子上，与前后幕同一套粒子语言。
