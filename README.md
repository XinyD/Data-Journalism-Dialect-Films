...
- **首页宇宙**：发布记录 63,025 部，覆盖封面与引言、四部叙事（港片那二十年 / 内地变少了与三波浪潮 / 占比下降以后的口碑 / 高分方言片的特征与大众化路径）及终章回响。序章可视点约 10,800 颗陆地粒子，封面另加约 7,500 颗尘埃，不是 6 万颗同时画满。
...
- **每幕数据卡**：标题跟随正文章节 badge，提供筛选、均值、中位数、标准差、四分位数、高分占比和随机打捞。
