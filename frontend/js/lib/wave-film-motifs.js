const MOTIF_IDS = [
    '1400868', '900089', '1303913', '900115', '1307914',
    '26337866', '26284621', '26633257', '27110296', '900072', '27191492',
    '3737102', '6829652', '27059130', '34902639', '34805873', '37116446'
];
...
function motifUnit(id) {
    if (id === '1400868') {
        // 警察故事：商场灯串上的一场打斗
        return line(0.5, 0.08, 0.5, 0.3, 12)
            .concat(ring(0.5, 0.3, 0.06, 0.05, 14))
            .concat(figure(0.5, 0.58, 0.26, 0.7, 110))
            .concat(line(0.26, 0.9, 0.74, 0.9, 26));
    }
    if (id === '900089') {
    ...
    if (id === '900115') {
        // 喜剧之王：海边练戏的龙套演员
        return figure(0.5, 0.52, 0.22, 0.66, 100)
            .concat(line(0.06, 0.76, 0.94, 0.76, 40))
            .concat(poly([[0.1, 0.9], [0.3, 0.84], [0.5, 0.92], [0.7, 0.85], [0.9, 0.9]], 34));
    }
    if (id === '1307914') {
    ...
    if (id === '26284621') {
        // 追凶者也：云南山路上的追凶
        return poly([[0.06, 0.9], [0.3, 0.7], [0.5, 0.78], [0.72, 0.56], [0.94, 0.62]], 64)
            .concat(figure(0.32, 0.6, 0.16, 0.5, 62))
            .concat(figure(0.62, 0.46, 0.14, 0.44, 54));
    }
    if (id === '26633257') {
    ...
    if (id === '27191492') {
        // 四个春天：屋檐下的四个春天与归燕
        return poly([[0.12, 0.52], [0.5, 0.28], [0.88, 0.52], [0.8, 0.55], [0.2, 0.55], [0.12, 0.52]], 66)
            .concat(figure(0.3, 0.72, 0.12, 0.36, 26))
            .concat(figure(0.44, 0.72, 0.12, 0.36, 26))
            .concat(figure(0.58, 0.72, 0.12, 0.36, 26))
            .concat(figure(0.72, 0.72, 0.12, 0.36, 26))
            .concat(poly([[0.16, 0.16], [0.23, 0.1], [0.3, 0.16]], 12))
            .concat(poly([[0.68, 0.14], [0.75, 0.08], [0.82, 0.14]], 12));
    }
    if (id === '3737102') {
        // 艋舺：庙口屋脊与一把刀
        return poly([[0.1, 0.56], [0.3, 0.36], [0.5, 0.26], [0.7, 0.36], [0.9, 0.56]], 72)
            .concat(line(0.5, 0.26, 0.5, 0.6, 20))
            .concat(line(0.6, 0.76, 0.9, 0.44, 26))
            .concat(ring(0.61, 0.75, 0.03, 0.03, 12));
    }
    if (id === '6829652') {
        // 女朋友，男朋友：并肩的三个少年
        return figure(0.28, 0.58, 0.18, 0.6, 60)
            .concat(figure(0.5, 0.54, 0.18, 0.64, 60))
            .concat(figure(0.72, 0.58, 0.18, 0.6, 60));
    }
    if (id === '27059130') {
    ...
    if (id === '34902639') {
        // 同学麦娜丝：凑成一桌的四个同学
        return figure(0.22, 0.56, 0.14, 0.46, 38)
            .concat(figure(0.41, 0.54, 0.14, 0.48, 38))
            .concat(figure(0.6, 0.54, 0.14, 0.48, 38))
            .concat(figure(0.79, 0.56, 0.14, 0.46, 38))
            .concat(line(0.12, 0.82, 0.9, 0.82, 38));
    }
    if (id === '34805873') {
